...
###########################################################################################################################################
    ...
    with open("/home/pi/research/CSV_Files/facial_data_0" + str(p) + ".csv", 'a') as newFile:
            newFileWriter = csv.writer(newFile)
            newFileWriter.writerow([m, str(percent_change_corner_dist), str(percent_change_mouth_height_range), str(percent_change_lip_vert_dist)]) #may need to add str(m)


    
m = 10 #subject label
p = 10 #default csv file name search
#Begin csv file naming logic
while p < 100:
    if os.path.isfile("/home/pi/research/CSV_Files/facial_data_0" + str(p) + ".csv") == True:
        p += 1
    elif os.path.isfile("/home/pi/research/CSV_Files/facial_data_0" + str(p) + ".csv") == False:
        with open('/home/pi/research/CSV_Files/facial_data_0' + str(p) + ".csv", 'w') as newFile:
            newFileWriter = csv.writer(newFile)
            newFileWriter.writerow(["Subject Number", 'Corner Distance Percent Change', 'Height Range Percent Change', "Lip Distance Percent Change"])
        break
...
while m < 100:
    ...
    find_smile("/home/pi/research/Test_2.0/S0" + str(m) + "_000.png", "/home/pi/research/Test_2.0/S0" + str(m) + "_001.png", str(p), str(m))
    m += 1

while m < 109:
    print("Image Subject: " + str(m))
    find_smile("/home/pi/research/Test_2.0/S" + str(m) + "_000.png", "/home/pi/research/Test_2.0/S" + str(m) + "_001.png", str(p), str(m))
    m += 1
